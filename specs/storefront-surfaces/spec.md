...
| B5 | Dropdown on Dawn (desktop + mobile drawer): `שמנים`, `שמן לגוף`, `body oil` | Native dropdown suppressed; ours renders RTL-correct with images/prices; keyboard nav works; `שמנים` shows body oils, not shampoos |
